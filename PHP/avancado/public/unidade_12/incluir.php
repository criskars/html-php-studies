...
if (isset($_POST['nomeproduto'])) {
    $resultado1 = uploadArquivo($_FILES['foto_grande']);
    $resultado2 = uploadArquivo($_FILES['foto_pequena']);
    ...
    $inserir .= "VALUES ";
    $inserir .= "('$nomeproduto','$descricaoproduto','$codigobarra',$tempoentrega,$categoriaID,$fornecedorID,$precounitario,$precorevenda,$estoque,'$imagem_grande','$imagem_pequena')";
    $qInserir = mysqli_query($con, $inserir);
    if (!$qInserir) {
...
$qCategorias = mysqli_query($con, $categorias);
if (!$qCategorias) {
...
$qFornecedores = mysqli_query($con, $fornecedores);
if (!$qFornecedores) {
    die("Falha na consulta ao banco");
}
?>
    ...
    <main>
        <div id="janela_formulario">
            <form action="incluir.php" method="post" enctype="multipart/form-data">
                ...
                <!-- campo de limite de tamanho de imagem -->
